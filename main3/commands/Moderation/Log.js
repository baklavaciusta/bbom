  ...
  async execute(client, interaction, data) {
    ...
    if (getCommand == "bilgi") {
      ...
      const webhook = await getChannel.createWebhook({
        name: 'modmail Logger',
        avatar: 'https://cdn.discordapp.com/attachments/1131971137635614853/1135268307751161997/face-png.png',
        reason: `modmail Log Sistemi • ${interaction.user.tag} tarafından açıldı.`
      }).catch(err => {
