...
module.exports = {
  ...
  async execute(client, interaction, data) {
    ...
    try {
      ...
      let destekSunucusuButon = new ButtonBuilder().setLabel('Destek Sunucusu').setURL("https://discord.gg/wWQd2n23eA");
      ...
      let mainPageEmbed = {
        ...
        fields: [
          {
            name: '**»** Botun Sahibi',
            value: `**•** **\`baklavaciusta\`** \`(ID: ${client.settings.owner})\``,
          },
          {
                ...
                embeds: [
                  {
                    ...
                    description: "🔒 Burası baklavaciabime abime özeldir!"
                  }
                ],
                components: [
                  {
              ...
              fields: [
                ...
                },
                {
                  ...
                  value:
                    ...
                    `**•** modmail Premium Kullanıcıları: \`${premiumUsers}\`\n` +
                    `**•** modmail ile Güçlendirilmiş Sunucular: \`${boostedGuilds}\``,
                },
              ],
            };
            ...
            if (interaction.user.id !== client.settings.owner)
              return interaction.editReply({
                embeds: [
                  {
                    color: client.settings.embedColors.red,
                    description: "🔒 Burası baklavaci abime özeldir!"
                  }
                ],
                components: [
                  {
