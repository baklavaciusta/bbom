...
module.exports = {
  ...
  async execute(client, interaction, data) {
    ...
    let destekSunucusuButon = new ButtonBuilder().setLabel('Destek Sunucusu').setURL(`https://discord.gg/wWQd2n23eA`).setStyle('Link');

    interaction.reply({
      content: `<https://discord.gg/wWQd2n23eA>`,
      embeds: [
        {
