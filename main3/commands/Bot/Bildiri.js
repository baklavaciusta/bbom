        ...
        embeds: [
          {
            ...
            description: `**•** Bildirine cevabımızı görmek istersen <#1131971137635614853> kanalına bakabilirsin. 👻`,
            image: {
        ...
        embeds: [
          {
            color: client.settings.embedColors.green,
            title: '**»** Bildirin İçin Teşekkürler!',
            description: `**•** Bildirine cevabımızı görmek istersen [destek sunucumuza](https://discord.gg/wWQd2n23eA) katılabilirsin. 👻`,
            image: {
              url: "https://media.discordapp.net/attachments/716503010301444197/1039857246705819658/Screenshot_20221109-140109_Twitter.jpg"
            }
          }
        ...
        components: [
          {
            data: { type: 1 }, components: [
              new ButtonBuilder().setLabel('Destek Sunucusu').setURL(`https://discord.gg/wWQd2n23eA`).setStyle('Link')
            ]
          },
        ]
      });
